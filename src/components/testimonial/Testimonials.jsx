...
const data = [
  {
    avatar: Avat1,
    name: "Edison Zhuang",
    review: `I knew Amy from the Software Developer Immersive Program offered under NTU as her trainer. Amy possessed a strong learning attitude. 
  ...
  },
  {
    avatar: Avat1,
    name: "Terence  Gaffud",
    review: `Amy is a good developer. She's well versed in JavaScript and has experience creating frontend using ReactJS, backend APIs using Express, 
